...
export OUTPUT_DIR="${OUTPUT_DIR:-/ai/0309/cloud/output/seg_balanced}"
...
export SAMPLER_ALPHA="${SAMPLER_ALPHA:-0.5}"
export SAMPLER_MIN_POSITIVE_RATIO="${SAMPLER_MIN_POSITIVE_RATIO:-0.005}"
export SAMPLER_MAX_WEIGHT="${SAMPLER_MAX_WEIGHT:-4.0}"
export SAMPLER_EMPTY_WEIGHT="${SAMPLER_EMPTY_WEIGHT:-1.0}"

export SEG_USE_CLASS_WEIGHTS="${SEG_USE_CLASS_WEIGHTS:-1}"
export SEG_CLASS_WEIGHT_MODE="${SEG_CLASS_WEIGHT_MODE:-sqrt_inv}"
